        ...
        <div class="services">
                ...
                <div class="text-center">
                    <div class="services-box">
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h3 style="font-size: 30px; font-family: sans-serif">Health care Provider</h3><br><br>				
                        </div>
                        <style>
            ...
            <div style="width:100%; margin:0 auto;">
                <div style="width: 50%; float: left">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img style="height: 240px; width: 400px" src="images/hsp.gif">
                ...
                <div style="width: 50%; float: right">
                    ...
                    <form action="user_code.jsp" method="get">
                        <table style="width:80%">
                            ...
                            <tr>
                                <td style=""><label style="color: #3c763d; font-size: 20px">Select Role:</label></td>
                                <td style="color: #080808"><select style=" width: 300px" name="role" required="">
                            ...
                            <tr>
                                <td><a style="color: #000; font-size: 20px" href="user_reg.jsp">Create Account!!</a></td>
