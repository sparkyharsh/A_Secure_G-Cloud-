                        ...
                        <form method="post" action="bio_info_upload" enctype="multipart/form-data">
                            ...
                            <center><table>
                                    ...
                                    <tr>
                                        ...
                                        <th style="color: #080808; background-color: #00abf0">Owner ID</th>
                                        ...
                                        <th style="color: #080808; background-color: #00abf0">Request</th>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #080808"><a style="color: #00abf0" href="request.jsp?id=<%=rs.getString("id")%>">Send</a></td>
