                        ...
                        <div class="navbar-collapse collapse">							
                            <div class="menu">
                                <br><br><ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation"><a href="owner_home.jsp" class="active">Patient Home</a></li>
                                        <li role="presentation"><a href="fileupload.jsp">File Upload</a></li>
        ...
        <section id="main-slider" class="no-margin">
            <div class="carousel slide">      
                <div class="carousel-inner">
                    <div class="item active" style="background-image: url(images/owner_home.png)">
                        <div class="container">
            ...
            <div class="footer">
                <div class="container">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                        <div class="copyright">
                             <!--<a target="_blank" href="#" s Reserved.-->
                        </div>
                        <!-- 
