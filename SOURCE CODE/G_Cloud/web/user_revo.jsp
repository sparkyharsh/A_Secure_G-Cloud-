                ...
                <div class="text-center">
                    <div class="services-box">
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h3 style="font-size: 35px">Attacker Details </h3>					
                        </div>
  ...
  color: white;
                            ...
                            <center><table>
                                    ...
                                    <tr>
                                        ...
                                        <th style="color: #080808; background-color: #00abf0">Revocation</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><a style="font-size: 15px; color: red" href="Block.jsp?id=<%=rs.getString("id")%>">Block</a></td>
