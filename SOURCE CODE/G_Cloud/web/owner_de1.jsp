                            ...
                            <div class="navbar-collapse collapse">							
                                <div class="menu">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation"><a href="file_de1.jsp">File Details</a></li>
                                        <li role="presentation"><a href="owner_de1.jsp" class="active">Patient Details</a></li>
                ...
                <div class="text-center">
                    <div class="services-box">
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h3 style="font-size: 35px">Patient Details</h3>					
                        </div>
...
th {
  ...
  color: white;
                            ...
                            <center><table>
                                    ...
                                    <tr>
                                        <th style="color: #080808; background-color: #00abf0">OID</th>
                                    ...
                                    <%
                                        ...
                                        ResultSet rs = st.executeQuery("select * from oreg");
                                        while (rs.next()) {
