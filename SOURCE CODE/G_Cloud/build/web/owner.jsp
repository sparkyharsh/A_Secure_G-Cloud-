        ...
        <div class="services">
                ...
                <div class="text-center">
                    <div class="services-box">
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h3 style="font-size: 30px; font-family: sans-serif">Patients Login</h3>	<br><br>				
                        </div>
                        <style>
            ...
            <div style="width:100%; margin:0 auto;">
                <div style="width: 50%; float: left">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img style="height: 200px; width: 400px" src="images/owner login11.jpg">
                ...
                <div style="width: 50%; float: right">
                    ...
                    <form action="owner_code.jsp" method="get">
                        <table style="width:80%">
                            ...
                            <tr>
                                ...
                                <td><input type="password" style="width: 300px" id="fname" name="pass" placeholder="Password" required><br></td> 
                            </tr>
                            <tr>
                                <td><a style="color: #000; font-size: 20px" href="owner_reg.jsp">Create Account!!</a></td>
