        ...
        <div class="services">
                ...
                <div class="text-center">
                    <div class="services-box">
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h3 style="font-size: 30px; font-family: sans-serif">AUTHORITY LOGIN HERE</h3>	<br><br>				
                        </div>
                        <style>
            ...
            <div style="width:100%; margin:0 auto;">
                <div style="width: 50%; float: left">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <img style="height: 200px; width: 400px" src="img/authority login.jpg">
                ...
                <div style="width: 50%; float: right">
                    ...
                    <form action="auth_code.jsp" method="get">
                        <table style="width:80%">

                            <tr>
                                <td><label style="color: #3c763d; font-size: 20px">Name:</label></td>
                                <td><input type="text" id="fname" style="width: 300px" name="name" placeholder="TA Name" pattern="[A-Za-z\s]+" required><br></td> 
                            </tr>
                            <tr>
