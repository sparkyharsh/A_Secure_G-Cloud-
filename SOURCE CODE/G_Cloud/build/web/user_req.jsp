                            ...
                            <div class="navbar-collapse collapse">							
                                <div class="menu">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation"><a href="user_de.jsp">HCP Details</a></li>
                ...
                <div class="text-center">
                    <div class="services-box">
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h3 style="font-size: 35px">HCP Request</h3>					
                        </div>
                        ...
                        <form method="post" action="bio_info_upload" enctype="multipart/form-data">
                            ...
                            <center><table>
                                    ...
                                    <tr>
                                        ...
                                        <th style="color: #080808; background-color: #00abf0">Owner Name</th>
                                        <th style="color: #080808; background-color: #00abf0">User ID</th>
                                        ...
                                        <th style="color: #080808; background-color: #00abf0">Response</th>
                                    ...
                                    %>
                                    <tr>
                                        <td style="color: #080808"><%=rs.getString("fid")%></td>
                                        <td style="color: #080808"><%=rs.getString("fname")%></td>
                                        <td style="color: #080808"><%=rs.getString("owner")%></td>
                                        <td style="color: #080808"><%=rs.getString("uid")%></td>
                                        <td style="color: #080808"><%=rs.getString("uname")%></td>
                                        <td style="color: #080808"><%=rs.getString("role")%></td>
                                        <td style="color: #080808"><%=rs.getString("country")%></td>
                                        <td><a style="font-size: 15px; color: green" href="response.jsp?id=<%=rs.getString("id")%>&time=<%=rs.getString("time")%>">Accept</a></td>
